      ...
      '<div class="login-wrapper">' +
        ...
        '<div class="login-header">' +
          '<div class="login-logo-ring">' +
            '<img class="login-logo-img" src="' + ((window.RJF && RJF.data && RJF.data.brand && RJF.data.brand.loginLogo) ? RJF.data.brand.loginLogo : '/icons/icon-error.png') + '" alt="রূপসা জনকল্যাণ ফাউন্ডেশন" onerror="this.onerror=null;this.src=\'/icons/icon-error.png\';">' +
          '</div>' +
